    ...
    <div x-show="openPrices" class="flex flex-row w-full justify-between mb-4">
      <div class="my-4 w-full">
        ...
        <div class="form-group mt-4">
          ...
          <input name="product_discount_price" class="border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-indigo-800" type="number" value="{{ $product->price->product_discount_price }}" />
        </div>
      </div>
    </div>
