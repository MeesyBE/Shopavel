<div  class="bg-indigo-900 shopavel-vertical-navigation-aside-wrapper"  x-show="userInterface">
    ...
    <div class="mx-4">
        <a class="flex px-4 py-3 my-2 hover:bg-indigo-700 hover:text-white rounded-lg shopavel-vertical-navigation-item " href="{{ route('users.index') }}">
    ...
    <div class="mx-4">
        <a class="flex px-4 py-3 my-2 hover:bg-indigo-700 hover:text-white rounded-lg shopavel-vertical-navigation-item " href="{{ route('settings.index') }}">
